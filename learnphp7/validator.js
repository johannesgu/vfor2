...
function validate_dog_gender(the_string) {
    if (the_string.toUpperCase() == 'MALE' || the_string.toUpperCase() == 'FEMALE') {
        return true;
    } else {
        return false;
    }
...
function validate_input(form) {
    ...
    if (!validate_dog_gender(form.dog_gender.value)) {
        error_message += "Invalid dog gender. ";
    }
